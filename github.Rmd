...
- (Git and Git Shell come with the Github Desktop installation)
- Open and sign in into the Github Desktop with the same username and password you used signing into Github.
- **Is there a need to configure Git as in GitHubs [own instructions](https://help.github.com/desktop/guides/getting-started/configuring-git-for-github-desktop/)?**

### Creating a local copy of a repository

Next, you will create a copy of the IODS-project repository -which you already cloned earlier - to your computer. Follow the instructions below:
...
If you can't / don't want to use GitHub Desktop to manage between your local files and your remote GitHub version, you can use the *Terminal* or *Git Shell* to create commits, push (upload) changes to GitHub and pull (download) changes from GitHub. 
...
Git Shell can be used to push and pull files from Github. In Windows, you can open Git Shell from the start menu of your computer. You can also start Git Shell from Github Desktop by right-clicking the repository name.

In Mac, you can use the Terminal. You find the Terminal either in the Applications, or you can press `Command + Space` and write 'Terminal' in the opening box. For the rest of the instructions, Git Shell instructions also apply for the Terminal. 


### Navigate with Git Shell / Terminal

When in Git Shell or Terminal, the first thing to do is to navigate into the folder of you repository. It is good to keep in mind that.

- When Git Shell opens, you can see the path to the current working directory in the first line. 
- If you open Git Shell from the Github Desktop, Git Shell opens in the repository folder in your computer and you are ready to start creating commits.
...
- Git shell usually opens in the "Documents" or "Github" -folder. If all you can see is `~`, then you are in the user home file of your computer.  

In order to navigate in Git Shell / Terminal, you will find these tips useful:  
...
Perhaps insert a short summary here describing what should have been accomplished by now. (which files should be seen where and which programs installed)
