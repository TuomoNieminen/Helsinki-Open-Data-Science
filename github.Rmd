...
- If you open Git Shell from Github Desktop yGit Shell opens in the repository folder in your computer and you are ready to start creating commits.
...
- The command `cd <foldername>` will get you to the next folder. Try it out and notice how the path changes. Note that you can write the whole path to your Github repository folder at once, if you remember the path or you can use the `TAB` button to autocomplete path names.
...
At this point you will have a Github account and you have a hunch how to use version control (Github Desktop or Git Shell/Terminal). You have the (forked) repository IODS-project under your GitHub account and copyed (cloned) locally on your computer.
...
5. Upload the Changes to Github
    ...
    + If you can't use Github Desktop or Git Shell you can add README file directly in the webpage into your repository with 'Create new file' or Upload files'.
