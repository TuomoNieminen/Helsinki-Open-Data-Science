...
1. Create a .RMarkdown file with RStudio (File > New File > R Markdown). R studio prompts for a title. The output of the title will be removed, so it does not matter in this case. Just press Ok.
