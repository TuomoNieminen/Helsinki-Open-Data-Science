...
Cloning the repository in Git, see Github's instructions [here](https://help.github.com/articles/cloning-a-repository/). Note that you will need to navigate into the folder where you want to copy the files. 
