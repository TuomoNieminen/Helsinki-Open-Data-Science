...
KESKEN. Perhaps insert a short summary here describing what should have been accomplished by now. (which files should be seen where and which programs installed)
