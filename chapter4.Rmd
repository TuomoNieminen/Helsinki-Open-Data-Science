...
--- type:VideoExercise lang:r aspect_ratio:62.5 xp:50 skills:1 key:f3942b76fc
## Video: Dimensionality reduction with PCA

*** =video_link
//player.vimeo.com/video/204164956
...
--- type:VideoExercise lang:r aspect_ratio:62.5 xp:50 skills:1 key:d35fcf3d41
## Video: Biplots

*** =video_link
//player.vimeo.com/video/204165420
...
- Adjust the code: the labels of the x-axis are showing poorly. Make the plot more readable by adding `theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5))` after barplot the code.
...
# visualize the dataset
gather(tea_time) %>% ggplot(aes(value)) + facet_wrap("key", scales = "free") + geom_bar() + theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5))
