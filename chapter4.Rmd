...
Wellcome to the *Dimensionality Reduction* chapter.
...
Principal Components Analysis (PCA) can be performed by two sightly different matrix decomposition methods from linear algebra: the Eigenvalue Decomposition and the Singular Value Decomposition (SVD). 
