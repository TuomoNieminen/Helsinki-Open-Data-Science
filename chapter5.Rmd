...
- Use `gather()` to convert BPRS to a long form assigning columns to key-value pairs.
...
# Use the glimpse() function to see what BPRSL looks like
...
test_object("BPRSL", incorrect_msg = "Did you create the `BPRSL` object?")
test_function("glimpse", args = "object",incorrect_msg = "Did you glipse BPRSL?")
test_error()
