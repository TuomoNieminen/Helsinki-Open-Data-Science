...
*** =instructions
- Read the `lrn14` data frame to memory with `read.table()`. The meta file for the data is [here](http://www.helsinki.fi/~kvehkala/JYTmooc/JYTOPKYS3-meta.txt)
...
--- type:NormalExercise lang:r xp:100 skills:1 key:2f5c9d30c7
